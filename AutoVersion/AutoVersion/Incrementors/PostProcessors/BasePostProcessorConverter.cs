...
{
    class BasePostProcessorConverter : TypeConverter
    {
        /// <summary>
        ...
        {
            BasePostProcessor[] processors = BuildVersionIncrementor.Instance.PostProcessors.GetPostProcessors();
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            {
                return BuildVersionIncrementor.Instance.PostProcessors[(string)value];
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                return ((BasePostProcessor)value).Name;
            }
